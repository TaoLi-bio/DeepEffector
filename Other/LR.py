...
grid_search_lr = GridSearchCV(estimator=base_classifier, param_grid=param_grid_lr,
...
print("Best Accuracy Score for Logistic Regression:")
...
cv_results = cross_validate(best_lr, X_train, y_train, cv=cv, scoring=scoring, return_train_score=True)
